<?php
    /** 
     * Paydoor Checkout Page (JS Disabled)
     * 
...
<div id="paydoor_checkout" class="no-js">
        ...
        <div class="bnomics-bitcoin-pane">
          <div class="bnomics-btc-info">
            ...
            <div class="bnomics-qr-code">
              ...
              <div class="bnomics-qr-code-hint"><a href="<?php echo $payment_uri ?>" target="_blank"><?=__('Open in wallet', 'paydoor-bitcoin-payments')?></a></div>
            </div>
            <!-- Right Side -->
            <div class="bnomics-amount">
              <div class="bnomics-bg">
                ...
                <div class="bnomics-address">
                  <div class="bnomics-address-text"><?=__('To this', 'paydoor-bitcoin-payments')?> <?=strtolower($crypto['name'])?> <?=__('address', 'paydoor-bitcoin-payments')?></div>
